...
from gstex.gstex import GStexModelConfig
from nerfstudio.pipelines.base_pipeline import VanillaPipelineConfig


blender_method = MethodSpecification(
    config = TrainerConfig(
    method_name="gstex-blender-nvs",
    ...
    description="gstex blender version",
)

dtu_method = MethodSpecification( 
    config = TrainerConfig(
    method_name="gstex",
    steps_per_eval_image=0,
    steps_per_eval_batch=0,
